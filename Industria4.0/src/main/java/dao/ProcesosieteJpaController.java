...
public class ProcesosieteJpaController implements Serializable {
    ...
    public void create(Procesosiete procesosiete) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleado = procesosiete.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado = em.getReference(idEmpleado.getClass(), idEmpleado.getId());
                procesosiete.setIdEmpleado(idEmpleado);
            }
            ...
            if (idEmpleado != null) {
                idEmpleado.getProcesosieteCollection().add(procesosiete);
    ...
    public void edit(Procesosiete procesosiete) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleadoOld = persistentProcesosiete.getIdEmpleado();
            Empleado idEmpleadoNew = procesosiete.getIdEmpleado();
            ...
            if (idEmpleadoNew != null) {
                ...
                procesosiete.setIdEmpleado(idEmpleadoNew);
            }
            ...
            if (idEmpleadoOld != null && !idEmpleadoOld.equals(idEmpleadoNew)) {
                idEmpleadoOld.getProcesosieteCollection().remove(procesosiete);
                idEmpleadoOld = em.merge(idEmpleadoOld);
            }
            if (idEmpleadoNew != null && !idEmpleadoNew.equals(idEmpleadoOld)) {
                idEmpleadoNew.getProcesosieteCollection().add(procesosiete);
    ...
    public void destroy(Short id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleado = procesosiete.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado.getProcesosieteCollection().remove(procesosiete);
                idEmpleado = em.merge(idEmpleado);
            }
            Inventario idInventario = procesosiete.getIdInventario();
            if (idInventario != null) {
