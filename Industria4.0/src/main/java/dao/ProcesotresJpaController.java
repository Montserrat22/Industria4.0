...
public class ProcesotresJpaController implements Serializable {
    ...
    public void create(Procesotres procesotres) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleado = procesotres.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado = em.getReference(idEmpleado.getClass(), idEmpleado.getId());
                procesotres.setIdEmpleado(idEmpleado);
            }
            ...
            if (idEmpleado != null) {
                idEmpleado.getProcesotresCollection().add(procesotres);
    ...
    public void edit(Procesotres procesotres) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleadoOld = persistentProcesotres.getIdEmpleado();
            Empleado idEmpleadoNew = procesotres.getIdEmpleado();
            ...
            if (idEmpleadoNew != null) {
                ...
                procesotres.setIdEmpleado(idEmpleadoNew);
            }
            ...
            if (idEmpleadoOld != null && !idEmpleadoOld.equals(idEmpleadoNew)) {
                idEmpleadoOld.getProcesotresCollection().remove(procesotres);
                idEmpleadoOld = em.merge(idEmpleadoOld);
            }
            if (idEmpleadoNew != null && !idEmpleadoNew.equals(idEmpleadoOld)) {
                idEmpleadoNew.getProcesotresCollection().add(procesotres);
    ...
    public void destroy(Short id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleado = procesotres.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado.getProcesotresCollection().remove(procesotres);
                idEmpleado = em.merge(idEmpleado);
            }
            Inventario idInventario = procesotres.getIdInventario();
            if (idInventario != null) {
