...
public class ProcesoseisJpaController implements Serializable {
    ...
    public void create(Procesoseis procesoseis) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleado = procesoseis.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado = em.getReference(idEmpleado.getClass(), idEmpleado.getId());
                procesoseis.setIdEmpleado(idEmpleado);
            }
            ...
            if (idEmpleado != null) {
                idEmpleado.getProcesoseisCollection().add(procesoseis);
    ...
    public void edit(Procesoseis procesoseis) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleadoOld = persistentProcesoseis.getIdEmpleado();
            Empleado idEmpleadoNew = procesoseis.getIdEmpleado();
            ...
            if (idEmpleadoNew != null) {
                ...
                procesoseis.setIdEmpleado(idEmpleadoNew);
            }
            if (iasientoNew != null) {
            ...
            if (idEmpleadoOld != null && !idEmpleadoOld.equals(idEmpleadoNew)) {
                idEmpleadoOld.getProcesoseisCollection().remove(procesoseis);
                idEmpleadoOld = em.merge(idEmpleadoOld);
            }
            if (idEmpleadoNew != null && !idEmpleadoNew.equals(idEmpleadoOld)) {
                idEmpleadoNew.getProcesoseisCollection().add(procesoseis);
    ...
    public void destroy(Short id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleado = procesoseis.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado.getProcesoseisCollection().remove(procesoseis);
                idEmpleado = em.merge(idEmpleado);
            }
            Interiorasiento iasiento = procesoseis.getIasiento();
            if (iasiento != null) {
