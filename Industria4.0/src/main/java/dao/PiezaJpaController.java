...
public class PiezaJpaController implements Serializable {
    ...
    public void create(Pieza pieza) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            utx.begin();
            em = getEntityManager();
            Preveedor idProveedor = pieza.getIdProveedor();
            if (idProveedor != null) {
                idProveedor = em.getReference(idProveedor.getClass(), idProveedor.getId());
                pieza.setIdProveedor(idProveedor);
            }
            ...
            em.persist(pieza);
            if (idProveedor != null) {
                idProveedor.getPiezaCollection().add(pieza);
    ...
    public void edit(Pieza pieza) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Preveedor idProveedorOld = persistentPieza.getIdProveedor();
            Preveedor idProveedorNew = pieza.getIdProveedor();
            ...
            if (idProveedorNew != null) {
                ...
                pieza.setIdProveedor(idProveedorNew);
            }
            ...
            if (idProveedorOld != null && !idProveedorOld.equals(idProveedorNew)) {
                idProveedorOld.getPiezaCollection().remove(pieza);
                idProveedorOld = em.merge(idProveedorOld);
            }
            if (idProveedorNew != null && !idProveedorNew.equals(idProveedorOld)) {
                idProveedorNew.getPiezaCollection().add(pieza);
    ...
    public void destroy(Short id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Preveedor idProveedor = pieza.getIdProveedor();
            if (idProveedor != null) {
                idProveedor.getPiezaCollection().remove(pieza);
                idProveedor = em.merge(idProveedor);
            }
