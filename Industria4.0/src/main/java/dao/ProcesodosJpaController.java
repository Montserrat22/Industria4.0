...
public class ProcesodosJpaController implements Serializable {
    ...
    public void create(Procesodos procesodos) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleado = procesodos.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado = em.getReference(idEmpleado.getClass(), idEmpleado.getId());
                procesodos.setIdEmpleado(idEmpleado);
            }
            ...
            if (idEmpleado != null) {
                idEmpleado.getProcesodosCollection().add(procesodos);
    ...
    public void edit(Procesodos procesodos) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleadoOld = persistentProcesodos.getIdEmpleado();
            Empleado idEmpleadoNew = procesodos.getIdEmpleado();
            ...
            if (idEmpleadoNew != null) {
                ...
                procesodos.setIdEmpleado(idEmpleadoNew);
            }
            ...
            if (idEmpleadoOld != null && !idEmpleadoOld.equals(idEmpleadoNew)) {
                idEmpleadoOld.getProcesodosCollection().remove(procesodos);
                idEmpleadoOld = em.merge(idEmpleadoOld);
            }
            if (idEmpleadoNew != null && !idEmpleadoNew.equals(idEmpleadoOld)) {
                idEmpleadoNew.getProcesodosCollection().add(procesodos);
    ...
    public void destroy(Short id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleado = procesodos.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado.getProcesodosCollection().remove(procesodos);
                idEmpleado = em.merge(idEmpleado);
            }
            Inventario idInventario = procesodos.getIdInventario();
            if (idInventario != null) {
