...
public class ProcesounoJpaController implements Serializable {
    ...
    public void create(Procesouno procesouno) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleado = procesouno.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado = em.getReference(idEmpleado.getClass(), idEmpleado.getId());
                procesouno.setIdEmpleado(idEmpleado);
            }
            ...
            if (idEmpleado != null) {
                idEmpleado.getProcesounoCollection().add(procesouno);
    ...
    public void edit(Procesouno procesouno) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleadoOld = persistentProcesouno.getIdEmpleado();
            Empleado idEmpleadoNew = procesouno.getIdEmpleado();
            ...
            if (idEmpleadoNew != null) {
                ...
                procesouno.setIdEmpleado(idEmpleadoNew);
            }
            ...
            if (idEmpleadoOld != null && !idEmpleadoOld.equals(idEmpleadoNew)) {
                idEmpleadoOld.getProcesounoCollection().remove(procesouno);
                idEmpleadoOld = em.merge(idEmpleadoOld);
            }
            if (idEmpleadoNew != null && !idEmpleadoNew.equals(idEmpleadoOld)) {
                idEmpleadoNew.getProcesounoCollection().add(procesouno);
    ...
    public void destroy(Short id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleado = procesouno.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado.getProcesounoCollection().remove(procesouno);
                idEmpleado = em.merge(idEmpleado);
            }
            Inventario idInventario = procesouno.getIdInventario();
            if (idInventario != null) {
