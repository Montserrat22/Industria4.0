...
public class ProcesoochoJpaController implements Serializable {
    ...
    public void create(Procesoocho procesoocho) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleado = procesoocho.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado = em.getReference(idEmpleado.getClass(), idEmpleado.getId());
                procesoocho.setIdEmpleado(idEmpleado);
            }
            ...
            if (idEmpleado != null) {
                idEmpleado.getProcesoochoCollection().add(procesoocho);
    ...
    public void edit(Procesoocho procesoocho) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleadoOld = persistentProcesoocho.getIdEmpleado();
            Empleado idEmpleadoNew = procesoocho.getIdEmpleado();
            ...
            if (idEmpleadoNew != null) {
                ...
                procesoocho.setIdEmpleado(idEmpleadoNew);
            }
            ...
            if (idEmpleadoOld != null && !idEmpleadoOld.equals(idEmpleadoNew)) {
                idEmpleadoOld.getProcesoochoCollection().remove(procesoocho);
                idEmpleadoOld = em.merge(idEmpleadoOld);
            }
            if (idEmpleadoNew != null && !idEmpleadoNew.equals(idEmpleadoOld)) {
                idEmpleadoNew.getProcesoochoCollection().add(procesoocho);
    ...
    public void destroy(Short id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleado = procesoocho.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado.getProcesoochoCollection().remove(procesoocho);
                idEmpleado = em.merge(idEmpleado);
            }
            Revisioncarroceria rcarroceria = procesoocho.getRcarroceria();
            if (rcarroceria != null) {
