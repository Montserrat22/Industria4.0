...
public class ProcesocincoJpaController implements Serializable {
    ...
    public void create(Procesocinco procesocinco) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleado = procesocinco.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado = em.getReference(idEmpleado.getClass(), idEmpleado.getId());
                procesocinco.setIdEmpleado(idEmpleado);
            }
            ...
            if (idEmpleado != null) {
                idEmpleado.getProcesocincoCollection().add(procesocinco);
    ...
    public void edit(Procesocinco procesocinco) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleadoOld = persistentProcesocinco.getIdEmpleado();
            Empleado idEmpleadoNew = procesocinco.getIdEmpleado();
            ...
            if (idEmpleadoNew != null) {
                ...
                procesocinco.setIdEmpleado(idEmpleadoNew);
            }
            ...
            if (idEmpleadoOld != null && !idEmpleadoOld.equals(idEmpleadoNew)) {
                idEmpleadoOld.getProcesocincoCollection().remove(procesocinco);
                idEmpleadoOld = em.merge(idEmpleadoOld);
            }
            if (idEmpleadoNew != null && !idEmpleadoNew.equals(idEmpleadoOld)) {
                idEmpleadoNew.getProcesocincoCollection().add(procesocinco);
    ...
    public void destroy(Short id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleado = procesocinco.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado.getProcesocincoCollection().remove(procesocinco);
                idEmpleado = em.merge(idEmpleado);
            }
            Inventario idInventario = procesocinco.getIdInventario();
            if (idInventario != null) {
