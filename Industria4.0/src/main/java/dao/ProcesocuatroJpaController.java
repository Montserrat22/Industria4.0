...
public class ProcesocuatroJpaController implements Serializable {
    ...
    public void create(Procesocuatro procesocuatro) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleado = procesocuatro.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado = em.getReference(idEmpleado.getClass(), idEmpleado.getId());
                procesocuatro.setIdEmpleado(idEmpleado);
            }
            ...
            if (idEmpleado != null) {
                idEmpleado.getProcesocuatroCollection().add(procesocuatro);
    ...
    public void edit(Procesocuatro procesocuatro) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleadoOld = persistentProcesocuatro.getIdEmpleado();
            Empleado idEmpleadoNew = procesocuatro.getIdEmpleado();
            ...
            if (idEmpleadoNew != null) {
                ...
                procesocuatro.setIdEmpleado(idEmpleadoNew);
            }
            ...
            if (idEmpleadoOld != null && !idEmpleadoOld.equals(idEmpleadoNew)) {
                idEmpleadoOld.getProcesocuatroCollection().remove(procesocuatro);
                idEmpleadoOld = em.merge(idEmpleadoOld);
            }
            if (idEmpleadoNew != null && !idEmpleadoNew.equals(idEmpleadoOld)) {
                idEmpleadoNew.getProcesocuatroCollection().add(procesocuatro);
    ...
    public void destroy(Short id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Empleado idEmpleado = procesocuatro.getIdEmpleado();
            if (idEmpleado != null) {
                idEmpleado.getProcesocuatroCollection().remove(procesocuatro);
                idEmpleado = em.merge(idEmpleado);
            }
            Inventario idInventario = procesocuatro.getIdInventario();
            if (idInventario != null) {
